...
def force_global_amplitude(imported_time,imported_qpos,imported_qvel,imported_qacc,imported_force):
...
def exploration_volumes(imported_time,imported_qpos,imported_qvel,imported_qacc,imported_force):
    ...
    return xlsindy.result_formatting.estimate_volumes(phase_portrait_explored,5) # 5th nearest neighboor density estimation

def force_std(imported_time,imported_qpos,imported_qvel,imported_qacc,imported_force):
...
if __name__ == "__main__":
    ...
    for function in metric_list:
        ...
        simulation_dict["metric"][function.__name__] = function(imported_time,imported_qpos,imported_qvel,imported_qacc,imported_force)
