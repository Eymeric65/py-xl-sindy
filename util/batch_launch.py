...
if __name__=="__main__":
    ...
    #cli verification
    if args.number_coordinate is None:
    ...
    for i in range(args.number_experiment):
        ...
        forces_vec = np.random.rand(args.number_coordinate)*(i/args.number_experiment*(args.forces_span[1]-args.forces_span[0]) + args.forces_span[0])

        commands += [mujoco_align_cmd_creator(args.experiment_folder,args.max_time,forces_vec)]
